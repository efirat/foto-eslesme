    ...
    if (acikKartImg.src === secilenKartImg.src) {
      ...
      /*
        ...
        */
        ...
        if(puan===4){
            setTimeout(() => {
                const kazandin = document.createElement("div");
                kazandin.classList.add("kazandin");
                kazandin.innerHTML = `<img src="img/confetti.gif">`;
                document.querySelector("body").appendChild(kazandin);
            }, 250);
